...
Tässä tutkielmassa TDD:n laatua ja tehokkuutta on mitattu arvioimalla ja vertaamalla 12 testivetoisesta kehityksestä tehtyä empiiristä tutkimusta. Tutkimuksia ei ole valikoitu minkään kriteerin perusteella, vaan otoksesta on pyritty tekemään mahdollisimman yleinen.
